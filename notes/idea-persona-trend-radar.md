...
Parked here so it isn't lost. Separate project from WeekendFun — if it gets
...
The same scoring WeekendFun already uses, pointed sideways. A topic appearing
...
has to match the one already taken on Reddit in WeekendFun: synthetic personas
...
## What would transfer from WeekendFun
